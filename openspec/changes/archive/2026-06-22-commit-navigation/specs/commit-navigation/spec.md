...
The system SHALL return to the launch ("home") view with `C` when the home view is local or staged changes or a review. When rsdiff was launched on a commit, `C` SHALL be inert.
