...
Let the user browse and switch the active theme through an interactive picker — a tabbed dark/light grid with whole-UI live preview, commit-to-apply, cancel-to-rollback, and persistence of the committed theme to the config file.
